  ...
  namespace React {
    namespace JSX {
      interface IntrinsicElements extends ThreeElements {
        line_: ReactThreeFiber.ThreeElement<typeof Line>;
      }
    }
  }
}
...
const Comet: React.FC = () => {
  ...
  return (
    <line_ ref={cometRef}>
      <bufferGeometry ref={cometGeomRef} attach="geometry" onUpdate={onUpdate}>
        <bufferAttribute
          args={[cometState?.position ?? new Float32Array([0, 0, 0]), 3]}
