import{r as o,j as e,n as a,L as d}from"./index-CO7j6vh9.js";import{u as m,L as g,g as u}from"./galleryItems-2GTaCqWJ.js";const y=a.li`
  aspect-ratio: 1;
`,x=a(d)`
  position: relative;
  display: block;
...
`,w=a.span`
  font-size: 16px;
`,I=({item:t})=>{const{register:r,deregister:s}=m(),i=o.useRef(null),[l,c]=o.useState(!1);return o.useEffect(()=>{if(i.current&&!l)return r(i.current,p=>{if(p.intersectionRatio>0){const n=new Image;n.onload=()=>{c(!0)},n.src="/kuaaa-gallery/"+t.thumbnail,console.log(n.src)}}),()=>{s()}},[s,l,t.thumbnail,r]),e.jsx(y,{ref:i,children:e.jsxs(x,{href:`/kuaaa-gallery//${t.id.replace(/^\//,"").replace(/\/$/,"")}/`,children:[e.jsx(b,{style:{...l&&{backgroundImage:`url(/kuaaa-gallery/${t.thumbnail})`,backgroundSize:"cover",backgroundPosition:"center",opacity:1},transitionDelay:`${Math.random()*.4}s, 0s`},className:"gallery-image"}),e.jsx(h,{className:"gallery-title",children:e.jsx(w,{children:t.title})}),e.jsx(f,{className:"gallery-border"})]})})},j=a.ul`
  display: grid;
  list-style: none;
  padding: 0;
  margin: 0;
